...
<div id="viewAnnouncementModal" class="modal">
    <div class="modal-content">
        ...
        <div class="announcement-form">
            <div id="viewAnnouncementLoading" class="view-loading-state fae-27">
                <div class="loading-spinner"></div>
                <p>Loading announcement...</p>
            </div>

            <div class="announcement-details fae-29">
                <div class="detail-item">
...
<div id="deleteAnnouncementModal" class="modal">
    <div class="modal-content modal-content-sm">
        ...
        <div class="announcement-form">
            <p class="fae-30">Are you sure you want to delete this announcement?</p>
            <p class="fae-31">This will hide the announcement from the system.</p>
