      ...
      <aside class="sidebar">
        <nav class="sidebar-nav">
          <div class="nav-section">
            ...
            <a href="counselor-dashboard.html" class="nav-item active">
              <i class="fas fa-tachometer-alt"></i>
              <span>Dashboard</span>
            </a>
            <a href="#pending-requests" class="nav-item">
              <i class="fas fa-clock"></i>
              <span>Pending Requests</span>
            </a>
            <a href="#approved-requests" class="nav-item">
              <i class="fas fa-check-circle"></i>
              <span>Approved Requests</span>
            </a>
            <a href="#rejected-requests" class="nav-item">
          ...
          <div class="requests-container">
            ...
            <div class="request-card high-request" data-urgency="high" data-type="tuition">
              ...
              <div class="request-details">
                <div class="detail-row">
                  <span class="detail-label">Amount Requested:</span>
                  <span class="detail-value amount">$1,800</span>
                </div>
                <div class="detail-row">
                  <span class="detail-label">Submitted:</span>
            ...
            <div class="request-card medium-request" data-urgency="medium" data-type="textbooks">
              ...
              <div class="request-details">
                <div class="detail-row">
                  <span class="detail-label">Amount Requested:</span>
                  <span class="detail-value amount">$350</span>
                </div>
                <div class="detail-row">
                  <span class="detail-label">Submitted:</span>
            ...
            <div class="request-card low-request" data-urgency="low" data-type="technology">
              ...
              <div class="request-details">
                <div class="detail-row">
                  <span class="detail-label">Amount Requested:</span>
                  <span class="detail-value amount">$800</span>
                </div>
                <div class="detail-row">
                  <span class="detail-label">Submitted:</span>
