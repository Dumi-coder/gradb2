      ...
      <main class="main-content">
        ...
        <section class="dashboard-section categories-section">
          ...
          <div class="categories-grid">
            <div class="category-card" onclick="window.location.href='<?=ROOT?>/student/resources/browse?category=lecture-notes'">
            ...
            <div class="category-card" onclick="window.location.href='<?=ROOT?>/student/resources/browse?category=assignments'">
              <div class="category-icon">
            ...
            <div class="category-card" onclick="window.location.href='<?=ROOT?>/student/resources/browse?category=textbooks'">
              <div class="category-icon">
            ...
            <div class="category-card" onclick="window.location.href='<?=ROOT?>/student/resources/browse?category=software'">
              <div class="category-icon">
