...
$page_subtitle = "Browse all forum discussions across all faculties";
...
<link rel="stylesheet" href="<?=ROOT?>/assets/css/discussion-forum.css">
      ...
      <main class="main-content">
        ...
        <section class="dashboard-section forum-topics-section">
          <div class="section-header">
            <div class="section-title-container">
              ...
              <div class="filter-controls">
                ...
                <a href="<?=ROOT?>/superadmin/forummoderation" class="btn btn-outline">
          ...
          <div class="topics-container">
            <?php 
            // Show ALL topics from all faculties
            ...
            <div class="topic-card">
              ...
              <div class="topic-footer">
                ...
                <div class="topic-actions sae-32">
                  ...
                  <button class="btn btn-outline btn-sm sae-52" onclick="deleteVisiblePost(<?= $topic->post_id ?>)">
    ...
    function showForumLoadingState() {
      ...
      if (!loader) {
        ...
        loader.innerHTML = '<div class="sae-53"><i class="fas fa-spinner fa-spin sae-54"></i><div class="sae-55">Loading forum content...</div></div>';
    ...
    function deleteVisiblePost(postId) {
      ...
      fetch(`<?=ROOT?>/superadmin/forummoderation/deletePost/${postId}`, {
        method: 'POST'
      })
      .then(response => response.json())
      .then(data => {
