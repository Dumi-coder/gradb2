        ...
        <section class="dashboard-section events-header-section">
            <div class="section-header">
                ...
                <div class="header-actions">
                    <button class="btn btn-outline btn-sm" id="superAdminPendingToggleBtn" onclick="toggleEventCards('superadmin-pending', this)">
                        <span>View More</span>
            ...
            <div class="featured-events-grid">
                <?php if (!empty($pendingEvents)): ?>
                    <?php foreach ($pendingEvents as $index => $event): ?>
                        <div class="featured-event-card js-card-superadmin-pending" <?= $index >= 2 ? 'style="display:none;"' : '' ?>>
                            ...
                            <div class="event-content">
                                ...
                                <div class="event-actions">
                                    ...
                                    <?php endif; ?>
                                    <button type="button" class="btn btn-primary btn-sm" onclick="handleSuperAdminEventDecision(<?= (int)$event['event_id'] ?>, 'approve', this)">
                                        <i class="fas fa-check"></i>
                                        <span>Approve</span>
                                    </button>
                                    <button type="button" class="btn btn-outline btn-sm" onclick="handleSuperAdminEventDecision(<?= (int)$event['event_id'] ?>, 'reject', this)">
...
function handleSuperAdminEventDecision(eventId, decision, button) {
...
document.addEventListener('DOMContentLoaded', function() {
    const toggleBtn = document.getElementById('superAdminPendingToggleBtn');
    const cards = document.querySelectorAll('.js-card-superadmin-pending');
