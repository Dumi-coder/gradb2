...
<link rel="stylesheet" href="<?=ROOT?>/assets/css/discussion-forum.css">
          ...
          <div class="section-header">
            <div class="section-title-container">
              ...
              <div class="filter-controls">
                ...
                <a href="<?=ROOT?>/superadmin/forummoderation/viewall" class="btn btn-outline">
                  <span>View All</span>
    ...
    function openEditForumModal(postId) {
      ...
      fetch(`<?=ROOT?>/superadmin/forummoderation/getPost/${postId}`)
    ...
    function submitNewPost(event) {
      ...
      fetch('<?=ROOT?>/superadmin/forummoderation/createPost', {
        method: 'POST',
        body: formData
      })
      .then(response => response.json())
    ...
    function submitEditForum(event) {
      ...
      fetch('<?=ROOT?>/superadmin/forummoderation/updatePost', {
        method: 'POST',
        body: formData
      })
      .then(response => response.json())
    ...
    function executeDelete() {
      ...
      fetch(`<?=ROOT?>/superadmin/forummoderation/deletePost/${postToDelete}`, {
        method: 'POST'
      })
      .then(response => response.json())
      .then(data => {
    ...
    function submitReply(event, postId) {
      ...
      fetch('<?=ROOT?>/superadmin/forummoderation/addReply', {
        method: 'POST',
        body: formData
      })
      .then(response => response.json())
    ...
    function submitEditReply(event) {
      ...
      fetch('<?=ROOT?>/superadmin/forummoderation/updatereply', {
        method: 'POST',
        headers: {
    ...
    function executeDeleteReply() {
      ...
      fetch('<?=ROOT?>/superadmin/forummoderation/deletereply', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    function deleteReply(replyId) {
      if (confirm('Are you sure you want to delete this reply?')) {
        fetch(`<?=ROOT?>/superadmin/forummoderation/deleteReply/${replyId}`, {
          method: 'POST'
        })
        .then(response => response.json())
        .then(data => {
    ...
    function toggleLikeReply(replyId, buttonElement) {
      fetch(`<?=ROOT?>/superadmin/forummoderation/likeReply/${replyId}`, {
        method: 'POST'
      })
      .then(response => response.json())
      .then(data => {
    ...
    function hidePost(postId) {
      if (confirm('Are you sure you want to hide this post?')) {
        fetch(`<?=ROOT?>/superadmin/forummoderation/hidePost/${postId}`, {
          method: 'POST'
        })
        .then(response => response.json())
        .then(data => {
    ...
    function warnUser(userId) {
      if (confirm('Send a warning to this user?')) {
        fetch(`<?=ROOT?>/superadmin/forummoderation/warnUser/${userId}`, {
          method: 'POST'
        })
        .then(response => response.json())
        .then(data => {
