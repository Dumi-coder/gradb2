    ...
    <main class="main-content">
        ...
        <section class="dashboard-section">
            ...
            <div class="users-container">
                ...
                <?php endforeach; ?>
                <?php else: ?>
                <div class="empty-state sae-69" id="no-suspended-users">
                    <i class="fas fa-user-check sae-70"></i>
                    <h4 class="sae-71">No Suspended Users</h4>
                    <p class="sae-72">The suspended users list is empty.</p>
                </div>
                <?php endif; ?>

                <div class="empty-state sae-73" id="no-search-results">
                    <i class="fas fa-search sae-74"></i>
                    <h4 class="sae-71">No Matching Users</h4>
                    <p class="sae-72">Try a different name, email, or ID.</p>
                </div>
            </div>

            <div id="reactivateConfirmModal" class="modal sae-27">
                <div class="modal-content sae-75">
                    <div class="modal-header sae-76">
                    ...
                    <div class="modal-body sae-67">
                        <p id="reactivateConfirmText" class="sae-77"></p>
                    </div>
        ...
        <section class="dashboard-section sae-78">
            <div class="section-header">
            ...
            <div class="users-container" id="active-users-container">
                ...
                <?php endforeach; ?>
                <?php else: ?>
                <div class="empty-state sae-69" id="no-available-users">
                    <i class="fas fa-check-circle sae-70"></i>
                    <h4 class="sae-71">No Users To Suspend</h4>
                    <p class="sae-72">All eligible users are currently suspended or unavailable.</p>
                </div>
                <?php endif; ?>

                <div class="empty-state sae-73" id="no-active-search-results">
                    <i class="fas fa-search sae-74"></i>
                    <h4 class="sae-71">No Matching Users</h4>
                    <p class="sae-72">Try a different name, email, or ID.</p>
                </div>
            ...
            <div id="suspendConfirmModal" class="modal sae-27">
                <div class="modal-content sae-75">
                    <div class="modal-header sae-76">
                    ...
                    <div class="modal-body sae-67">
                        <p id="suspendConfirmText" class="sae-77"></p>
                    </div>
                    <div class="form-actions">
