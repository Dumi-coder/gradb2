...
<?php
if (!function_exists('renderMentorshipSectionCardSuperadmin')) {
    function renderMentorshipSectionCardSuperadmin($card)
    {
        ...
        <article class="mentorship-card">
            ...
            <div class="card-actions">
                ...
                <?php if ($mentorUserId > 0): ?>
                    <a class="btn btn-outline btn-sm" href="<?= ROOT ?>/superadmin/Userprofile?id=<?= $mentorUserId ?>">
            ...
            <div class="cards-wrap">
                <?php if (!empty($mentorshipData['pending'])): ?>
                    <?php foreach ($mentorshipData['pending'] as $card): ?>
                        <?php renderMentorshipSectionCardSuperadmin($card); ?>
                    <?php endforeach; ?>
                <?php else: ?>
                    <div class="empty-state">Nothing pending right now. New mentorship requests will appear here.</div>
                <?php endif; ?>
            </div>
        </section>
        ...
        <section class="dashboard-section">
            ...
            <div class="cards-wrap">
                <?php if (!empty($mentorshipData['ongoing'])): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <div class="empty-state">No ongoing mentorship sessions at the moment.</div>
                <?php endif; ?>
            </div>
        </section>
        ...
        <section class="dashboard-section">
            ...
            <div class="cards-wrap">
                <?php if (!empty($mentorshipData['completed'])): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <div class="empty-state">No completed mentorship sessions yet. Completed sessions will be listed here.</div>
                <?php endif; ?>
            </div>
        </section>
    </main>
