...
<html lang="en">
  <head>
    ...
    <title>Super Admin Login - GradBridge</title>
...
<section class="auth-section gradient-hero">
  <div class="container">
    <div class="auth-card">
      <h1 class="auth-title">Super Admin <span class="brand">Login</span></h1>
      ...
      <form class="auth-form" method="POST">
        ...
        <input class="input" type="email" name="email" placeholder="Super Admin Email" required />
      ...
      <p class="auth-meta"><a href="<?=ROOT?>/PasswordReset?role=super_admin">Forgot password?</a></p>
