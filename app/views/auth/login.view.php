      ...
      <div class="container">
        <div class="auth-card">
          ...
          <div style="display:grid; gap: 1rem; grid-template-columns: 1fr;">
            <a class="btn btn-secondary" href="<?=ROOT?>/student/Auth?action=login">I am a Student</a>
            <a class="btn btn-outline" href="<?=ROOT?>/alumni/Auth?action=login">I am an Alumni</a>
          </div>
        </div>
      </div>
    </section>
