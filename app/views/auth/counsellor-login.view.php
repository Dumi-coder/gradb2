...
<html lang="en">
  <head>
    ...
    <title>Counsellor Login - GradBridge</title>
...
<section class="auth-section gradient-hero">
  <div class="container">
    <div class="auth-card">
      <h1 class="auth-title">Counsellor <span class="brand">Login</span></h1>
      ...
      <form class="auth-form" method="POST">
        ...
        <input class="input" type="email" name="email" placeholder="Counsellor Email" required />
      ...
      <p class="auth-meta"><a href="<?=ROOT?>/PasswordReset?role=counsellor">Forgot password?</a></p>
