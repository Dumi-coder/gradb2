...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav-list">
            ...
            <li class="nav-item <?= (isset($current_page) && $current_page === 'fundraisers') ? 'active' : '' ?>">
                <a href="<?=ROOT?>/alumni/fundraisers" class="nav-link" data-tooltip="Fundraisers">
                    <svg class="nav-icon" viewBox="0 0 24 24">
            ...
            <li class="nav-item <?= (isset($current_page) && $current_page === 'resources') ? 'active' : '' ?>">
                <a href="<?=ROOT?>/alumni/resources/index" class="nav-link" data-tooltip="Resources">
                    <svg class="nav-icon" viewBox="0 0 24 24">
