...
<head>
    ...
    <title><?= $title ?? 'Counsellor Dashboard - GradBridge' ?></title>
...
<body>
    <script>
        ...
        function logout() {
            ...
            form.method = 'POST';
            form.action = '<?=ROOT?>/counsellor/logout';
            ...
            <div class="header-content">
                <div class="welcome-section">
                    ...
                    <?php if (!empty($page_title)): ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <h1 class="welcome-text">Welcome, <span class="counsellor-name"><?= esc($_SESSION['name'] ?? 'Counsellor') ?></span></h1>
                        <p class="counsellor-role">Counsellor</p>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="profile-dropdown">
                        ...
                        <div class="profile-dropdown-menu" id="profileDropdownMenu">
                            <div class="dropdown-header">
                                <span class="dropdown-name"><?= esc($_SESSION['name'] ?? 'Counsellor') ?></span>
                                <span class="dropdown-role">Counsellor</span>
                            </div>
                            <div class="dropdown-divider"></div>
                            <a href="<?=ROOT?>/counsellor/profile" class="dropdown-item">
                                <i class="fas fa-user"></i>
                                <span>My Profile</span>
                            </a>
                            <a href="<?=ROOT?>/Counsellor/ProfileEdit" class="dropdown-item">
