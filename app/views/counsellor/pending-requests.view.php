    ...
    <section class="dashboard-section">
      <div class="section-header section-header-flex">
        ...
        <div class="toolbar-inline">
          <!-- <a href="<?=ROOT?>/counsellor/approved-requests" class="btn btn-outline btn-sm">Accepted</a> -->
          <!-- <a href="<?=ROOT?>/counsellor/rejected-requests" class="btn btn-outline btn-sm">Rejected</a> -->
        </div>
      </div>
