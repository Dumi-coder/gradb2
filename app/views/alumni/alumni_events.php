    ...
    <main class="main-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header">
                ...
                <p class="page-subtitle">Explore alumni and student-organized events. Publish, register, and view event details.</p>

            </div>

            <!-- Publish Event Button Section -->
                    ...
                    <div class="upload-action-container">
                        ...
                        <div class="upload-action-content">
                            ...
                            <div class="upload-action-info">
                                ...
                                <p>Create a new event to connect with fellow alumni and students. Share knowledge, network, and build community.</p>

                            </div>

                            <div class="upload-action-button">

                                <button id="publishEventBtn" class="btn btn-primary" style="background-color: #000000 !important; color: white !important; border: 2px solid #000000 !important; font-weight: bold !important;">
                        ...
                        <?php foreach ($registeredEvents as $event): ?>
                            ...
                            <div class="event-card registered-event">
                                ...
                                <div class="event-card-footer">
                                    ...
                                    <button class="btn btn-danger btn-sm" onclick="unregisterEvent(<?php echo $event['id']; ?>)" style="background-color: #000000 !important; color: white !important; border: 2px solid #000000 !important; font-weight: bold !important;">
...
<div id="eventModal" class="modal-overlay" onclick="closeEventModal()">
    ...
    <div class="modal-content event-modal" onclick="event.stopPropagation()">
        ...
        <div class="modal-footer">
            ...
            <button id="modalUnregisterBtn" class="btn btn-secondary" onclick="unregisterFromEvent()" style="display: none; background-color: #000000 !important; color: white !important; border: 2px solid #000000 !important; font-weight: bold !important;">Unregister</button>
    ...
    <div class="modal-content" onclick="event.stopPropagation()">
        ...
        <form class="publish-event-form" onsubmit="submitNewEvent(event)">
            ...
            <div class="form-actions">
                ...
                <button type="button" class="btn btn-secondary" onclick="closePublishEventModal()" style="border: 2px solid #000000 !important; color: #000000 !important; background-color: white !important; font-weight: bold !important;" onmouseover="this.style.backgroundColor='#000000'; this.style.color='white';" onmouseout="this.style.backgroundColor='white'; this.style.color='#000000';">Cancel</button>

                <button type="submit" class="btn btn-primary" style="background-color: #000000 !important; color: white !important; border: 2px solid #000000 !important; font-weight: bold !important;">Submit for Approval</button>
