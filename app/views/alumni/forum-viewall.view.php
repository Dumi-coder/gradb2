...
$page_subtitle = "Browse all forum discussions";
...
<link rel="stylesheet" href="<?=ROOT?>/assets/css/discussion-forum.css">
          ...
          <div class="section-header">
            <div class="section-title-container">
              ...
              <div class="filter-controls">
                ...
                <a href="<?=ROOT?>/alumni/discussionforum" class="btn btn-outline">
    ...
    function showForumLoadingState() {
      ...
      if (!loader) {
        ...
        loader.className = 'forum-detail-loading-overlay';
        loader.innerHTML = '<div class="forum-detail-loading-content"><i class="fas fa-spinner fa-spin forum-detail-loading-icon"></i><div class="forum-detail-loading-text">Loading forum content...</div></div>';
    ...
    function submitReply(event, postId) {
      ...
      const replyText = form.reply.value.trim();
