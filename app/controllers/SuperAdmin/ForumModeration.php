...
class ForumModeration extends Controller
{
    public function index()
    {
        ...
        // Get all posts (superadmin sees everything)
        $faculty_posts = $forumModel->getAllPosts();
        ...
        $this->view('superadmin/forum-moderation', $data);
    }
    ...
    public function createPost()
    {
        ...
        $data = [
            ...
            'tags' => $_POST['tags'] ?? '',
            'visiblefaculties' => $_POST['faculty_id'] ?? '999', // 999 = all faculties
        ];
    ...
    public function viewall()
    {
        ...
        // Get all posts (superadmin sees everything, no limit)
        $all_posts = $forumModel->getAllPosts();
        ...
        $this->view('superadmin/forum-viewall', $data);
    }
}
