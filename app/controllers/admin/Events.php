...
class Events extends Controller
{
    ...
    public function index()
    {
        ...
        $events = $facultyId ? $this->eventModel->getModerationEvents($facultyId) : [];
        ...
        $data = [
            ...
            'page_subtitle' => 'Monitor and manage events organized by alumni in your faculty.',
            'user' => $_SESSION,
            'events' => $events,
    ...
    public function register()
    {
        ...
        $facultyId = $this->getFacultyIdForAdmin();
        $event = $facultyId ? $this->eventModel->getModerationEventById($eventId, $facultyId) : false;
        if (!$event) {
            $this->jsonFail('Event not found for your faculty');
            return;
        }
    ...
    private function assertAdminJsonAuth()
    {
        if (session_status() == PHP_SESSION_NONE) {
            session_start();
        }
